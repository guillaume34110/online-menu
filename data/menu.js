export const menuItems = [
  ...
  "ja": "繊細な黄金色のクレープに、自家製いちごジャムをたっぷりと。太陽の光を浴びて熟したいちごの爽やかな酸味とやさしい甘さが、なめらかな舌触りとともに広がります。軽やかで甘いひとときの味わいです。",
  ...
  "ja": "タイの太陽の下で熟した果実から作った自家製パパイヤとパッションフルーツのジャムを添えた、南国の陽気なクレープ。パパイヤのまろやかな甘さとパッションフルーツの魅惑的な酸味が、爽やかなトロピカルダンスを織りなします。香り豊かな庭園と市場を思わせる、明るく華やかな一皿です。",
