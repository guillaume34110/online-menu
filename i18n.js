...
const translations = {
  fr: {
    ...
    'header.closedMonday': 'Fermé le lundi',
    'category.all': 'Tous',
  ...
  en: {
    ...
    'header.closedMonday': 'Closed on Mondays',
    'category.all': 'All',
  ...
  de: {
    ...
    'header.closedMonday': 'Montags geschlossen',
    'category.all': 'Alle',
  ...
  ru: {
    ...
    'header.closedMonday': 'Закрыто по понедельникам',
    'category.all': 'Все',
  ...
  es: {
    ...
    'header.closedMonday': 'Cerrado los lunes',
    'category.all': 'Todos',
  ...
  it: {
    ...
    'header.closedMonday': 'Chiuso il lunedì',
    'category.all': 'Tutti',
  ...
  nl: {
    ...
    'header.closedMonday': 'Op maandag gesloten',
    'category.all': 'Alle',
  ...
  pt: {
    ...
    'header.closedMonday': 'Fechado às segundas-feiras',
    'category.all': 'Todos',
    'connection.connected': 'Conectado',
    'connection.connecting': 'Conectando...',
    'connection.disconnected': 'Desconectado',
  ...
  th: {
    ...
    'header.closedMonday': 'หยุดวันจันทร์',
